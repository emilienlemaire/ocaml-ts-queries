...
(let_binding
  pattern: (value_name) @definition.function
  (set! definition.var.scope "parent"))

(let_binding
  pattern: (tuple_pattern (value_name) @definition.function)
  (set! definition.var.scope "parent"))

(let_binding
  pattern: (record_pattern (field_pattern (value_name) @definition.function))
  (set! definition.var.scope "parent"))
